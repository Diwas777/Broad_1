namespace Broadway
{
	partial class Form1
	{
		...
		{
			this.FirstDigit = new System.Windows.Forms.Label();
			...
			// FirstDigit
			// 
			this.FirstDigit.AutoSize = true;
			this.FirstDigit.Location = new System.Drawing.Point(63, 40);
			this.FirstDigit.Name = "FirstDigit";
			this.FirstDigit.Size = new System.Drawing.Size(47, 13);
			this.FirstDigit.TabIndex = 0;
			this.FirstDigit.Text = "FirstDigit";
			// 
			// textBox1
			// 
		...
		private System.Windows.Forms.Label FirstDigit;
